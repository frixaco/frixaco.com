...
export function ModeToggle() {
  ...
  if (!mounted) {
    return (
      <div className="bg-cyber-bg-alt flex size-8 items-center justify-center self-end rounded-full">
        <MonitorIcon className="text-cyber-grey size-5" />
      </div>
    );
  }
  ...
  return (
    <div className="relative size-8 self-end">
      ...
      >
        <div
          className={cn(
            "absolute top-1.5 left-1.5 flex h-19 w-5 flex-col items-center gap-2 transition-transform duration-300 ease-out will-change-transform group-hover:translate-y-0",
            translateClass,
