...
### Rewriting with signals: from spaghetti to architecture

#### Title was: Building a TUI Library from scratch using Bun and Rust: Part 2

#### Description was: Rewriting everything with signals-based reactivity, functional components, better API and more

#### Originally posted Dec 13, 2025
